...
$perf_score   = $exam_perf ? $exam_perf['score'] : $percent;
$perf_text    = $exam_perf
    ? htmlspecialchars($exam_perf['rating']) . ' (' . $exam_perf['score'] . '%)'
    : $percent . '% of the Qur’an completed';
...
<style>
    ...
    .cert-photo{
        width:30mm;height:36mm;margin:4mm auto;border:0.4mm solid #c9a24b;border-radius:1.5mm;
        padding:1mm;background:#fff;box-shadow:0 2mm 6mm rgba(15,23,42,.12);position:relative;z-index:1;
    }
    .cert-photo img{width:100%;height:100%;object-fit:cover;border-radius:.8mm;display:block;background:#f0ede3;}
    ...
    @media print{
        ...
        .cert-sheet{
            width:210mm;height:297mm;max-width:none;margin:0;padding:5mm;
            border-radius:0;box-shadow:none;break-inside:avoid;page-break-inside:avoid;
        }
        .cert-border{height:287mm;min-height:287mm;padding:11mm 13mm 8mm;border-radius:1.5mm;}
        ...
        <div class="cert-sheet">
            <div class="cert-border">
                ...
                <?php if (!empty($student['profile_image'])): ?>
                    <div class="cert-photo"><img src="/uploads/profile_pics/<?= htmlspecialchars($student['profile_image']) ?>" alt="Student photo"></div>
                <?php endif; ?>
                ...
                <div class="cert-progress">
                    <div class="progress">
                        <div class="progress-fill gold" style="width:<?= $perf_score ?>%"></div>
                        <div class="progress-text"><?= $perf_text ?></div>
                    </div>
                </div>
