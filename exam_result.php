...
<style>
    .result-sheet{
        background:#fff;max-width:820px;margin:0 auto;padding:10px;
        border-radius:var(--radius-lg);box-shadow:var(--shadow-lg);
    }
    .result-border{
        border:3px double var(--gold);border-radius:14px;padding:34px 40px;background:#fff;
    }
    .result-header{text-align:center;border-bottom:1px solid var(--border);padding-bottom:16px;margin-bottom:20px;}
    .result-header h1{font-size:1.35rem;margin:0 0 2px;}
    ...
    .result-title{
        ...
        letter-spacing:.18em;color:var(--gold-deep);text-transform:uppercase;margin:6px 0 4px;
    }
    .result-name{text-align:center;font-size:1.7rem;margin:8px 0 2px;color:var(--emerald-900);}
    .result-email{text-align:center;color:var(--text-muted);font-size:.85rem;margin:0 0 16px;}
    .result-overall{
    ...
    .result-overall .num{font-family:var(--font-display);font-size:2rem;font-weight:800;}
    .result-overall .lbl{font-size:.78rem;text-transform:uppercase;letter-spacing:.06em;opacity:.9;}
    table.result-table{width:100%;border-collapse:collapse;font-size:.9rem;margin-bottom:18px;}
    table.result-table th,table.result-table td{border:1px solid var(--border);padding:10px 12px;text-align:left;}
